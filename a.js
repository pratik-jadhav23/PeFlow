...
function extractStatementInfo(text) {
  ...
  const formattedStartDate = `${months[startDateObj.getMonth()]}, ${String(startDateObj.getDate()).padStart(2, '0')} ${startDateObj.getFullYear()}`;
  const formattedEndDate = `${months[endDateObj.getMonth()]}, ${String(endDateObj.getDate()).padStart(2, '0')} ${endDateObj.getFullYear()}`;
...
// Execution
const result = extractStatementInfo(text);
console.log("Start Date:", result.formattedStartDate); // Nov, 01 2025
console.log("End Date:", result.formattedEndDate);     // Nov, 30 2025
console.log("Total Days:", result.totalDays);          // 29